...
class DogeIncelDeque(deque):
    """
    A dogeincel deque. A doqe, if you may.
    ...
    def __init__(self, *args, **kwargs):
        ...
        args = list(args)
        random.shuffle(args)
        super(DogeIncelDeque, self).__init__(args)
    ...
    def extend(self, iterable):
        ...
        super(DogeIncelDeque, self).extend(iterable)
        self.shuffle()
...
class FrequencyBasedDogeIncelDeque(deque):
    def __init__(self, *args, **kwargs):
        self.index = 0
        if "step" in kwargs:
        ...
        super(FrequencyBasedDogeIncelDeque, self).__init__(args)
    ...
    def extend(self, iterable):
        ...
        super(FrequencyBasedDogeIncelDeque, self).__init__(new_to_add)


PREFIXES = DogeIncelDeque(
...
# DogeIncel checks if current date falls in between these dates and show wow
